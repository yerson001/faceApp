...
# resnet50 model to get 128D face descriptor
...
class Face_Recognizer:
    ...
    def get_face_database(self):
        if os.path.exists("data/features_all.csv"):
            ...
            logging.info("Faces in DB： %d", len(self.face_features_known_list))
            return 1
        else:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "FPS:    " + str(self.fps.__round__(2)), (20, 130), self.font, 0.8, (0, 255, 0), 1,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "Caras:  " + str(self.current_frame_face_cnt), (20, 160), self.font, 0.8, (0, 255, 0), 1,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "Q: Salir", (20, 450), self.font, 0.8, (255, 255, 255), 1, cv2.LINE_AA)
        ...
        if self.get_face_database():
            while stream.isOpened():
                ...
                if (self.current_frame_face_cnt == self.last_frame_face_cnt) and (
                    ...
                    logging.debug("scene 1:   No face!!")

                    self.current_frame_face_position_list = []

                    if "Desconocido" in self.current_frame_face_name_list:
                    ...
                    if self.current_frame_face_cnt == 0:
                        ...
                        for k in range(len(faces)):
                            ...
                            if min(self.current_frame_face_X_e_distance_list) < 0.5:
